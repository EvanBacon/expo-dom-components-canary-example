...
```typescript
const crew = [
  { name: "Captain Elena Vyasa", role: "Commanding Officer" },
  { name: "Ensign Niro", role: "Chief Science Officer" },
  { name: "Dr. Riya Morales", role: "Xenolinguist" },
  { name: "Lieutenant Kael", role: "Chief Engineer" },
];
```
